...
import {IoMdAdd, IoMdSearch, IpMdSearch} from 'react-icons/io';
...
export default function Navbar({ searchTerm, setSearchTerm, user }) {
    ...
    return (
        <div className='flex gap-2 md:gap-5 w-full mt-5 pb-7'>
            <div className='flex justify-start items-center px-2 rounded-md bg-white border-none outline-none w-full focus-within:shadow-sm'>
